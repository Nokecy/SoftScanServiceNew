...
/**
 * The BarCodeReaderBank class is used to set bar code reader settings, start/stop preview,
 ...
 *
 * <ol>
 * <li>Obtain an instance of BarCodeReaderBank with {@link #open(int)}.
 *
 ...
 *
 * <li><b>Important:</b> Call {@link #release()} to release the BarCodeReaderBank for
 * use by other applications.  Applications should release the BarCodeReaderBank
...
public class BarCodeReaderBank
{
	...
	static {
		...
		if(android.os.Build.VERSION.SDK_INT >= 28){
			System.loadLibrary("barcodereader90"); // Android 9.0
	...
	private static final String TAG = "BarCodeReaderBank";
	 ...
	 * BarCodeReaderBank objects are locked by default unless {@link #unlock()} is
	 ...
	 * Normally, the reader is locked to the process with an active BarCodeReaderBank
	 ...
	 * {@link android.media.MediaRecorder#setCamera(BarCodeReaderBank)}.
	 *
	 * <p>If you are not recording video, you probably do not need this method.
	 *
	 ...
	 * done recording if {@link android.media.MediaRecorder#setReader(BarCodeReaderBank)}
	 * was used.
	 *
	 * <p>If you are not recording video, you probably do not need this method.
	 *
	 ...
	 *
	 * <p>{@link VideoCallback#onVideoFrame(format, width, height, byte[], BarCodeReaderBank)}
	 ...
	 * called, {@link PreviewCallback#onPreviewFrame(byte[], BarCodeReaderBank)}
	 ...
	 * {@link #BarCodeReader.DecodeCallback.onDecodeComplete(int, int, byte[], BarCodeReaderBank)}
	 ...
	 * {@link OnZoomChangeListener#onZoomChange(int, boolean, BarCodeReaderBank)}
	 ...
	 *
	 *	public static void setReaderDisplayOrientation(Activity activity, int readerId, BarCodeReaderBank reader)
	 *	{
	 *		int		result;
	 *		int		degrees = 0;
	 *		int		rotation = activity.getWindowManager().getDefaultDisplay().getRotation();
	 *	 	BarCodeReaderBank.ReaderInfo	info = new BarCodeReaderBank.ReaderInfo();
	 *		BarCodeReaderBank.getReaderInfo(readerId, info);
	 *		switch (rotation)
	 *		{
	 ...
	 *		}
	 *
	 *		if ( info.facing == BarCodeReaderBank.ReaderInfo.BCRDR_FACING_FRONT )
	 *		{
	 ...
	 * BarCodeReaderBank object and instantiate a new one.
	 * @see ErrorCallback
	 */
	...
	/**
	 * Creates a new BarCodeReaderBank object to access a particular hardware reader.
	 *
	 * <p>You must call {@link #release()} when you are done using the reader,
	 * otherwise it will remain locked and be unavailable to other applications.
	 *
	 * <p>Your application should only have one BarCodeReaderBank object active at a time
	 ...
	 *
	 * @return a new BarCodeReaderBank object, connected, locked and ready for use.
	 *
	 * @throws RuntimeException if connection to the reader service fails (for
	 *	 example, if the reader is in use by another process).
	 */
	public static BarCodeReaderBank open(int readerId)
	{
		return(new BarCodeReaderBank(readerId));
	}

	/**
	 * Creates a new BarCodeReaderBank object to access the first back-facing reader on
	 * the device. If the device does not have a back-facing reader, this returns null
	 *
	 * @see #open(int)
	 */
	public static BarCodeReaderBank open()
	{
	...
	//	readerInfo = new BarCodeReaderBank.ReaderInfo();
		for ( iIdx = 0; iIdx < iNumReaders; ++iIdx )
		{
			//BarCodeReaderBank.getReaderInfo(iIdx, readerInfo);
			//if ( readerInfo.facing == BarCodeReaderBank.ReaderInfo.BCRDR_FACING_BACK )
			{
				return(new BarCodeReaderBank(iIdx));
			}
		}
		return(null);
	}
	 ...
	 *	 example, if the reader is in use by another process).
	 */
	public static BarCodeReaderBank open(int readerId, Context context)
	{
		return(new BarCodeReaderBank(readerId, context));
	}
	 ...
	 * @see #open(int)
	 */
	public static BarCodeReaderBank open(Context context)
	{
		ReaderInfo	readerInfo;
		...
		//{
			...
			//if ( readerInfo.facing == BarCodeReaderBank.ReaderInfo.BCRDR_FACING_BACK )
			{
				return(new BarCodeReaderBank(iNumReaders, context));
			}
		//}
		//return(null);
	}

	BarCodeReaderBank(int readerId)
	{
		Looper aLooper;
		...
		native_setup(new WeakReference<BarCodeReaderBank>(this), readerId);
	}
	
	BarCodeReaderBank(int readerId, Context context)
	{
		Looper aLooper;
		...
		native_setup(new WeakReference<BarCodeReaderBank>(this), readerId, context);
	}
	...
	/**
	 * Disconnects and releases the BarCodeReaderBank object resources.
	 *
	 * <p>You must call this as soon as you're done with the BarCodeReaderBank object.</p>
	 */
	...
	public interface AutoFocusCallback
	{
		 ...
		 * @param reader	the BarCodeReaderBank service object
		 */
		void onAutoFocus(boolean success, BarCodeReaderBank reader);
	};
	 ...
	 * it is a no-op and {@link AutoFocusCallback#onAutoFocus(boolean, BarCodeReaderBank)}
	...
	public interface DecodeCallback
	{
		 ...
		 * @param reader the BarCodeReaderBank service object.
		 */
		void onDecodeComplete(int symbology, int length, byte[] data, BarCodeReaderBank reader);
		 ...
		 * @param reader the BarCodeReaderBank service object.
		 */
		void onEvent(int event, int info, byte[] data, BarCodeReaderBank reader);
	};
	...
	public interface PictureCallback
	{
		 ...
		 * @param reader	the BarCodeReaderBank service object
		 */
		void onPictureTaken(int format, int width, int height, byte[] data, BarCodeReaderBank reader);
	};
	...
	public interface VideoCallback
	{
		 ...
		 * @param reader	the BarCodeReaderBank service object
		 */
		void onVideoFrame(int format, int width, int height, byte[] data, BarCodeReaderBank reader);
	};
	...
	public interface PreviewCallback
	{
		 ...
		 * @param reader the BarCodeReaderBank service object.
		 */
		void onPreviewFrame(byte[] data, BarCodeReaderBank reader);
	};
	...
	{
		private BarCodeReaderBank mReader;

		public EventHandler(BarCodeReaderBank rdr, Looper looper)
		{
			super(looper);
			mReader = rdr;
		}
	...
	private static void postEventFromNative(Object reader_ref, int what, int arg1, int arg2, Object obj)
	{
        ...
        BarCodeReaderBank c = (BarCodeReaderBank) ((WeakReference<BarCodeReaderBank>) reader_ref).get();
	...
	public interface OnZoomChangeListener
	{
		 ...
		 * @param reader	the BarCodeReaderBank service object
		 */
		void onZoomChange(int zoomValue, boolean stopped, BarCodeReaderBank reader);
	};
	...
	public interface ErrorCallback
	{
		 ...
		 * @param reader	the BarCodeReaderBank service object
		 */
		void onError(int error, BarCodeReaderBank reader);
	};
	...
	/**
	 * Changes the settings for this BarCodeReaderBank service.
	 *
	 * @param params the Parameters to use for this BarCodeReaderBank service
	...
	/**
	 * Returns the current settings for this BarCodeReaderBank service.
	...
	/**
	 * BarCodeReaderBank service settings.
	 *
	 * <p>To make reader parameters take effect, applications have to call
	 * {@link BarCodeReaderBank#setParameters(Parameters)}. For example, after
	 * {@link Parameters#setWhiteBalance} is called, white balance is not
	 * actually changed until {@link BarCodeReaderBank#setParameters(Parameters)}
	...
	public class Parameters
	{
		...
		/**
		 * Applications are looking for a barcode. BarCodeReaderBank driver will be
